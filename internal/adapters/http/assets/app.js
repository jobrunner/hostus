  ...
  function renderSuggest(q, res) {
    ...
    results.forEach(function (item, i) {
      ...
      if (matched && matched.canonical) {
        ...
        // Warum diese Zeile im Ranking hinten steht: der ausloesende Name
        // traegt einen disqualifizierenden nom_status. Der Roh-Status haengt
        // als Tooltip am Badge — abgewertet und gekennzeichnet, nie
