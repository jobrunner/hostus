...
--   n-uc5-lusus                  OTHER + rank_verbatim 'lusus' -> publishable
...
INSERT INTO name (id, canonical, canonical_fold, authorship, rank, ipni_id, published_in, nom_status, basionym_id) VALUES
  ...
  ('n-uc5-lusus',                   'uc5 corynephorus articulatus',  'uc5 corynephorus articulatus',  'Desf.',               'OTHER',   NULL, NULL, NULL,                     NULL),
...
INSERT INTO concept_name (concept_id, name_id, role, homotypic) VALUES
  ...
  ('c-uc5-corynephorus', 'n-uc5-lusus',                   'synonym',  NULL),
...
UPDATE name SET rank_verbatim = 'lusus' WHERE id = 'n-uc5-lusus';
